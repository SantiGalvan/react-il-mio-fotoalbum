    ...
    return (
        <div className={`${categoryCardStyle.card} card`} style={{ backgroundColor: color }}>
            ...
            <div className='d-flex justify-content-center gap-2'>
                <button className={`${categoryCardStyle.btn} btn btn-sm btn-warning`}><Pencil />Modifica</button>
                <button className={`${categoryCardStyle.btn} btn btn-sm btn-danger`}><Trash />Elimina</button>
            </div>
        </div>
    )
}
